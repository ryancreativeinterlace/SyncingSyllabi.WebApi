...
{
    public partial class SyllabusBaseRepository : ISyllabusBaseRepository, IBaseRepository<SyncingSyllabiDataContext>
    {
        DatabaseSettings _databaseSettings;
        SyncingSyllabiSettings _syncingSyllabiSettings;
        IMapper _mapper;

        public SyllabusBaseRepository(DatabaseSettings databaseSettings, SyncingSyllabiSettings syncingSyllabiSettings)
        {
