...
{
    public partial class NotificationBaseRepository : INotificationBaseRepository, IBaseRepository<SyncingSyllabiDataContext>
    {
        DatabaseSettings _databaseSettings;
        IMapper _mapper;

        public NotificationBaseRepository(DatabaseSettings databaseSettings)
        {
