...
{
    public partial class AssignmentBaseRepository : IAssignmentBaseRepository, IBaseRepository<SyncingSyllabiDataContext>
    {
        DatabaseSettings _databaseSettings;
        SyncingSyllabiSettings _syncingSyllabiSettings;
        IMapper _mapper;

        public AssignmentBaseRepository(DatabaseSettings databaseSettings, SyncingSyllabiSettings syncingSyllabiSettings)
        {
